...
- [x] **Value Objects** para los DTOs de request — patrón declarativo `validate()` con VOs aplicado en todos los servicios (`cat-service`, `adoption-service`, `organization-service`, `chat-service`, `user-service`).
