...
- [x] **Value Objects** for remaining request DTOs — declarative `validate()` pattern with VOs applied across all services (`cat-service`, `adoption-service`, `organization-service`, `chat-service`, `user-service`).
